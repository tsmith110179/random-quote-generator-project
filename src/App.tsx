...
function App() {
  ...
  <div className="background" style={{ backgroundColor: randomColor, transition }}>
   ...
   <div className="quote-content" style={{color: randomColor, transition}}>
    <h2 id="text">
    <FaQuoteLeft size="30" style={{marginRight: "10px"}} id="mobile-size" />
    {quote.quote}
    <FaQuoteRight size="30" style={{marginLeft: "10px"}} id="mobile-size" />
    </h2>
    <h4 id="author">- {quote.author}</h4>
    </div>
    <div className="buttons">
      <a href={`https://www.x.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=${quote.quote}`}
      id="tweet-quote"
      style={{
